...
profiles_religion %>% 
  ...
  arrange(desc(`Gender Prop by Religion`)) %>% 
  kable() 
...
ggplot(profiles_religion, aes(x=grouped_religion, y= `Gender Prop by Religion`))  + geom_point()

#will make a ggplot in descending order to represent the distribution
